...
namespace ProcessMonitor.Dialog
{
    class NotifyData
    {
    ...
    public partial class NotificationDialog : Window
    {
        ...
        public NotificationDialog()
        {
            ...
            this.Loaded += NotificationDialog_Loaded;
        }
        ...
        private void NotificationDialog_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            NotificationDialog self = sender as NotificationDialog;
            if (self != null)
            {
                self.UpdateLayout();
                ...
                animation.To = right - self.ActualWidth;//设定通知从右往左弹出L
